      ...
      <div class="pull-right">
        <div class="user-content__box clearfix bgf">
          ...
          <div class="modify_div" v-if="!show">
            <div class="clearfix">
              <a class="but" @click="show=true">修改登陆密码</a>
              <a class="but" @click="show=true">忘记登陆密码</a>
            </div>
          ...
          <div v-if="show">
            ...
            <div v-if="active === 1">
              <el-form :model="form1" ref="form1" :rules="rules1">
                <el-form-item prop="pwd">
                  <el-input v-model="form1.pwd" placeholder="请输入原密码" style="width: 280px;"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <div v-if="active === 3">
              <div class="modify-success__box text-center">
                ...
                <div class="text c6">登录密码设置成功！</div>
                <a class="btn">{{times}}秒后跳转至登陆页面，如果浏览器未跳转请点击这里</a>
              </div>
            </div>
          </div>
        </div>
